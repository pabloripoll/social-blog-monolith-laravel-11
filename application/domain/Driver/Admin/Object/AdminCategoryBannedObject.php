...
use Domain\Driver\Category\Validation\AdminCategoryBannedValidation;

class AdminCategoryBannedObject extends DomainObjectAbstract implements DomainObjectInterface
{
    /**
