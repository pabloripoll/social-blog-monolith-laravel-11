...
use Domain\Driver\Category\Validation\AdminCategoryNotificationValidation;

class AdminCategoryNotificationObject extends DomainObjectAbstract implements DomainObjectInterface
{
    /**
