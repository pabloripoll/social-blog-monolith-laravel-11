 ...
 */
class AdminNotificationValidation extends DomainValidationAbstract
{
    ...
    public function from_id($value)
    {
        return $this->_val()->id($value) ? $value : $this->error = [__FUNCTION__ => 'not valid'];
    }

    public function from_pid($value)
    {
        return $this->_val()->id($value) ? $value : $this->error = [__FUNCTION__ => 'not valid'];
    }
    ...
    public function from_ref($value)
    {
        return $this->_val()->text($value, [0, 64]) ? $value : $this->error = [__FUNCTION__ => 'not valid'];
    }
