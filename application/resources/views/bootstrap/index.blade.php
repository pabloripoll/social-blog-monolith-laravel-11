    ...
    <div class="col-lg-8 mx-auto p-4 py-md-5">
        <header class="d-flex align-items-center pb-3 mb-5 border-bottom">
            <a href="/" class="d-flex align-items-center text-body-emphasis text-decoration-none">
                ...
                <span class="fs-4">Starter template · Bootstrap v5.3</span>
            </a>
        </header>
        <main>
            <h1 class="text-body-emphasis">Get started with Bootstrap</h1>
            <p class="fs-12 col-md-12">Quickly and easily get started with Bootstrap's compiled, production-ready files with this barebones example featuring some basic HTML and helpful links. Download all our examples to get started.</p>
            <hr class="col-12 col-md-12 mb-5">
            <div class="row g-5">
                <div class="col-md-6">
                    <h2 class="text-body-emphasis">Page Examples</h2>
                    ...
                    <ul class="list-unstyled ps-0">
                        @foreach ($pages as $k => $page)
                            <li>
                                <a class="icon-link mb-1" href="/bootstrap/{{ $page }}" rel="noopener">
                ...
                <div class="col-md-6">
                    <h2 class="text-body-emphasis">Elements / Tools</h2>
                    <p>Read more detailed instructions and documentation on using or contributing to Bootstrap.</p>
                    <ul class="list-unstyled ps-0">
                        @foreach ($elements as $k => $element)
                            <li>
                                <a class="icon-link mb-1" href="/bootstrap/{{ $element }}" rel="noopener">
                                    <svg class="bi" width="16" height="16">
                                        <use xlink:href="#arrow-right-circle" />
                                    </svg>
                                    {{ $element }}
                ...
                <div class="col-md-12">
                    <h2 class="text-body-emphasis">Bootstrap Examples</h2>
                    <p>Ready to go beyond the starter template? Check out these open source projects that you can quickly duplicate to a new GitHub repository.</p>
                    <ul class="list-unstyled ps-0">
                        <li>
