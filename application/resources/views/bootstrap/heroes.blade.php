...
<head>
    ...
    <link href="/theme/bootstrap/template/heroes.css" rel="stylesheet">
</head>
        ...
        <div class="px-4 pt-5 my-5 text-center border-bottom">
            ...
            <div class="overflow-hidden" style="max-height: 30vh;">
                <div class="container px-5">
                    <img src="/theme/bootstrap/template/bootstrap-docs.png" class="img-fluid border rounded-3 shadow-lg mb-4" alt="Example image" width="700" height="500" loading="lazy">
                </div>
            </div>
        </div>
