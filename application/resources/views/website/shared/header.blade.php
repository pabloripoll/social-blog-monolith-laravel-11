@include('website.shared.theme')

<div class="container-fluid">
    <header class="pt-3 pb-3 mb-3 border-bottom">
        <div class="container-fluid p-0">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <a href="/home.html" class="navbar-brand p-0 me-2">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    <li>
                        <a href="/posts.html" class="nav-link px-2 @if($layout == 'posts' || $layout == 'post') @else link-body-emphasis @endif">POSTS</a>
                    </li>
                    <li>
                        <a href="/wall.html" class="nav-link px-2 @if($layout == 'wall') @else link-body-emphasis @endif">WALL</a>
                    </li>
                </ul>
                ...
                @else
                    <div class="flex-shrink-0 dropdown">
                        ...
                        <ul class="dropdown-menu text-small shadow">
                            ...
                            <li>
                                <a class="dropdown-item" href="/member/exit">Sign out</a>
                            </li>
                        </ul>
                    </div>
                @endif
